...
CREATE TYPE "public"."doc_kind" AS ENUM('doc', 'wiki');--> statement-breakpoint
CREATE TYPE "public"."project_status" AS ENUM('planning', 'active', 'paused', 'completed', 'archived');--> statement-breakpoint
CREATE TYPE "public"."requirement_status" AS ENUM('open', 'in_progress', 'done', 'cancelled');--> statement-breakpoint
...
CREATE TABLE "documents" (
	...
	"title" varchar(200) DEFAULT '未命名文档' NOT NULL,
...
ALTER TABLE "ai_conversations" ADD CONSTRAINT "ai_conversations_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_requirement_id_requirements_id_fk" FOREIGN KEY ("requirement_id") REFERENCES "public"."requirements"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
